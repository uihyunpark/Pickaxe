...
{
    [UnityEditor.CustomEditor(typeof(FolderColorSettings))] // Fix: Fully qualify the CustomEditor attribute
    public class FolderColorSettingsEditor : UnityEditor.Editor // Fix: Use UnityEditor.Editor instead of Editor
    {
